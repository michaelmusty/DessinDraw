 ...
 "Full" (computes the full matrix and the SVD).}
  ...
  if prec ne 0 then
    if prec ne DD`prec then
      vprint Shimura : "WARNING: precision input into TrianglePowerSeriesBasis is different than specified in Gamma";
      ...
      repeat
        ...
        if true then // to get Magma timing
          ...
          */
          ...
          Append(~minsings, minsing);
          vprintf Shimura: "error: %o", RealField(2)!minsing;
          if minsing lt eps_thresh then 
            vprintf Shimura: " < eps = %o\n", RealField(2)!eps_thresh;
          else
            vprintf Shimura: " >= eps = %o\n", RealField(2)!eps_thresh;
          end if;
        end if;
        ...
        */
      until minsing lt eps_thresh or 
        (#minsings gt 50 and minsing lt eps_thresh^(9/10) and minsing ge minsings[#minsings-1]);  // can be some hiccups at the end
