...
declare attributes GrpPSL2:  // = Gamma, a Fuchsian group
  ...
  TriangleUnscaledNumericalCurveCoefficients,
                    // Numerical approximation for curve coefficients, before rescaling

  TriangleUnscaledNumericalBelyiMapNumeratorCoefficients,
                    // Numerical approximation for coefficients of numerator of Belyi map, before rescaling
  TriangleUnscaledNumericalBelyiMapDenominatorCoefficients,
                    // Numerical approximation for coefficients of denominator of Belyi map, before rescaling
  ...
  TriangleCurveValuations,
                    // Valuations (integers) for Riemann-Roch basis used to compute curve

  TriangleBelyiMapNumeratorValuations,
                    // Valuations (integers) for Riemann-Roch basis used to compute Belyi map numerator

  TriangleBelyiMapDenominatorValuations,
                    // Valuations (integers) for Riemann-Roch basis used to compute Belyi map denominator
  ...
  */
  ...
  TriangleNewtonRamificationMultiplicities0Extra, // ramification multiplicity of point w=0 (oo_minus on hyperelliptic curve)
  ...
  TriangleNewtonDebug,
  TriangleNewtonNumeratorZeroIndices, // record which variables of numerator are zero as a result of echelonization
  TriangleNewtonDenominatorZeroIndices, //
  TriangleNewtonNumericalCommonZeroes, // record common zeroes of the numerator and denominator
  /*
  MISC
  */
